...
class AndroidSNetworkCallbackAdapter @Inject constructor(
    @Named("NetworkCallbackFlags") private val flags: Int,
    private val connectivityManager: ConnectivityManager,
    private val externalScope: CoroutineScope,
    ): NetworkCallbackAdapter {

    override fun networkCallbackFlow(): Flow<NetworkEvent> = callbackFlow {
        val networkCallback = object: ConnectivityManager.NetworkCallback(flags) {
